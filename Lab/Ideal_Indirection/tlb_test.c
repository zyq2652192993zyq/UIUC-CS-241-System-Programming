...
int main(int argc, char *argv[]) {
    ...
    switch (test_number) {
        case 1: return check_empty(&tlb);
        case 2: return insert_1_node(&tlb);
        case 3: return insert_capacity_nodes(&tlb);
        case 4: return insert_over_capacity_nodes(&tlb);
        case 5: return get_first_element_size_1_list(&tlb);
        case 6: return get_first_element_max_capacity_list(&tlb);
        case 7: return get_last_element_max_capacity_list(&tlb);
        case 8: return get_middle_element_max_capacity_list(&tlb);
        default:
            fprintf(stderr, "%s\n", "Invalid test number");
            return 13;
    }
